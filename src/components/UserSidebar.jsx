...
const UserSidebar = () => {
  return (
    <div className='w-3/12 h-full border-r-1 flex flex-col gap-1'>
      <div className='w-full h-1/12 flex items-center justify-center bg-gray-600'>
         <input type="text" placeholder='Search' className='w-10/12 h-9/12 bg-gray-800 rounded-full outline-none pl-5 text-gray-200 pr-11' />
         <FiSearch className='text-lg text-gray-200 relative z-10 -left-8'/>
      </div>

      {/* Sorting people based on different things */}
      <div className='w-full h-1/14'>
